...
<div class="min-h-[calc(100vh-65px)] flex">
    ...
    <div class="hidden lg:flex lg:w-[45%] xl:w-[40%] relative overflow-hidden bg-gradient-to-br from-primary-900 via-primary-800 to-primary-700 flex-col justify-between p-12">
        ...
        <div class="absolute -top-20 -right-20 w-80 h-80 rounded-full bg-primary-500 opacity-20 blur-3xl"></div>
        <div class="absolute -bottom-32 -left-10 w-72 h-72 rounded-full bg-primary-400 opacity-15 blur-3xl"></div>
        ...
        <div class="relative z-10">
            <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary-700/60 border border-primary-600/40 mb-8">
                ...
                <span class="text-primary-200 text-[11px] font-bold uppercase tracking-widest">Bergabung Sekarang</span>
            </div>
            <h2 class="text-4xl xl:text-5xl font-black text-white leading-tight">
                Buat Akun<br>
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary-200 to-primary-400">Administrator</span>
            </h2>
            <p class="mt-4 text-primary-100/70 text-base leading-relaxed max-w-sm">
                Daftar dan mulai kelola semua acara serta kegiatan sekolah Anda.
            </p>

            <ul class="mt-8 space-y-3">
                @foreach(['Akses penuh ke panel admin', 'Buat & edit acara kapan saja', 'Organisir kategori dengan mudah'] as $feat)
    ...
    {{-- ======== RIGHT PANEL (Form) ======== --}}
    <div class="flex-1 flex items-center justify-center px-6 py-12 bg-white lg:bg-gray-50/50 overflow-y-auto">
        <div class="w-full max-w-md" x-data="{ showPass: false, showConfirm: false }">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-500 text-sm mt-1.5">Isi formulir berikut untuk mendaftar sebagai administrator.</p>
            </div>
            ...
            <div class="mb-6 p-4 rounded-2xl bg-red-50 border border-red-200">
                <div class="flex items-start gap-3 mb-2">
                    ...
                    <p class="text-sm text-red-600 font-bold pt-0.5">Terdapat kesalahan:</p>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input :type="showConfirm ? 'text' : 'password'" id="password_confirmation" name="password_confirmation"
                               ...
                               class="w-full pl-12 pr-12 py-3.5 rounded-2xl border border-gray-200 bg-white text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-300 focus:border-primary-400 transition-all duration-200">
                        <button type="button" @click="showConfirm = !showConfirm" class="absolute inset-y-0 right-0 pr-4 flex items-center text-gray-400 hover:text-primary-500 transition-colors duration-200">
            ...
            <div class="text-center">
                <p class="text-sm text-gray-500">
                    Sudah punya akun?
                    <a href="/login" class="font-bold text-primary-600 hover:text-primary-700 hover:underline transition-colors duration-200 ml-1">
                        Masuk di Sini
                    </a>
                </p>
            </div>

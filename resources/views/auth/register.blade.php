...
<div class="min-h-[calc(100vh-8rem)] flex items-center justify-center px-4 py-12 bg-gradient-to-br from-white via-primary-50/50 to-primary-100/30">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <div class="absolute -top-40 -left-40 w-80 h-80 bg-primary-200/20 rounded-full blur-3xl"></div>
        <div class="absolute -bottom-40 -right-40 w-80 h-80 bg-primary-300/15 rounded-full blur-3xl"></div>
    </div>

    <div class="w-full max-w-md relative" x-data="{ showPassword: false, showConfirm: false }">
        ...
        <div class="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl shadow-gray-200/40 border border-white/60 p-8 sm:p-10">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-sm text-gray-500 mt-1">Bergabung dengan SchoolEvent untuk mengelola acara sekolah.</p>
            </div>
            ...
            <div class="mb-6 p-4 rounded-xl bg-red-50 border border-red-100">
                <div class="flex items-start gap-3 mb-2">
                    ...
                    <p class="text-sm text-red-600 font-medium">Terdapat kesalahan pada input Anda:</p>
                </div>
                <ul class="ml-8 space-y-1">
                    @foreach ($errors->all() as $error)
                        <li class="text-sm text-red-500 flex items-center gap-1.5">
            ...
            <form method="POST" action="/register" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input :type="showPassword ? 'text' : 'password'" id="password" name="password" placeholder="Minimal 8 karakter" required
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input :type="showConfirm ? 'text' : 'password'" id="password_confirmation" name="password_confirmation" placeholder="Ulangi password Anda" required
                               class="w-full pl-11 pr-12 py-3 rounded-xl border border-gray-200 bg-gray-50/50 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-300 focus:border-primary-300 focus:bg-white transition-all duration-200">
                        <button type="button" @click="showConfirm = !showConfirm" class="absolute inset-y-0 right-0 pr-3.5 flex items-center text-gray-400 hover:text-primary-500 transition-colors duration-200">
            ...
            <div class="mt-8 text-center">
                <p class="text-sm text-gray-500">
                    Sudah punya akun?
                    <a href="/login" class="font-semibold text-primary-600 hover:text-primary-700 hover:underline transition-colors duration-200">
                        Masuk di sini
                    </a>
                </p>
            </div>
